...
import com.glektarssza.player_handling_customizer.commands.TeleportCrossDimensionCommand;
...
public class PlayerHandlingCustomizer {
    ...
    public void onServerStarting(FMLServerStartingEvent event) {
        LOGGER.info("Registering server commands for {}...", Tags.MOD_NAME);
        event.registerServerCommand(new TeleportCrossDimensionCommand());
        LOGGER.info("Done registering server commands for {}!", Tags.MOD_NAME);
    }
